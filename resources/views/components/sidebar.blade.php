...
<div class="sidebar">
  ...
  <a href="{{ route('account.profile') }}" id="profile-link"><i class="fa fa-fw fa-user"></i> My Profile</a>
  <a href="{{ route('account.editProfile') }}" id="profile-link"><i class="fa fa-fw fa-edit"></i> Edit Profile</a>
  <a href="{{ route('account.changePassword') }}" id="profile-link"><i class="fa fa-fw fa-wrench"></i> Change Password</a>
  ...
  <a href="{{route('account.newReport')}}" id="profile-link"><i class="fa fa-fw fa-plus"></i> New Report</a>
  <a href="{{route('account.reportHistory')}}" id="profile-link"><i class="fa fa-fw fa-history"></i> Report History</a>
</div>
